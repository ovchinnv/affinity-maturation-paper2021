...
% number of runs and epitopes/bcr pairs
if (~exist('ag1s'))
 if (~exist('nrun'))
  nrun=6;
 end
 ag1s=ones(1, nrun); % [epitope1] for reach run
end
nrun=length(ag1s) ; % number of vaccinations/infections
...
%
%
ibc0=zeros(1,nclass);ibc0(8)=minimum_xi ; % initial affinity dist
