...
ags1s={ '1-1-1-1-1-1', '2-2-1.5-1.1-1-1' '2-1-1-2-1-1' } ;
...
%elseif (ioc==2)
 text(1.1,0.2+iag*0.1,['\it\alpha_1^T=',strrep(char(ags1),'-',', ') ] ,'fontsize',12, 'color',char(colors(iag)))
...
if (ioc==1)
 ...
 if (k12==10)
  text(0.,3e3,'A','fontsize',17)
 elseif (k12==0)
  text(0.,3e3,'B','fontsize',17)
 end

 l=legend(leg) ; legend boxoff ; set(l, 'fontsize',10)
...
print(gcf, '-dtiff', ['mbctime-k12=',num2str(k12),'.tif']);
print(gcf, '-depsc2', ['mbctime-k12=',num2str(k12),'.eps']);
figure(f2);
set(gcf, 'paperpositionmode','auto');
print(gcf, '-dtiff', ['afftime-k12=',num2str(k12),'.tif']);
print(gcf, '-depsc2', ['afftime-k12=',num2str(k12),'.eps']);
